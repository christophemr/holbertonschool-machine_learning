...
class Yolo:
    ...
    def preprocess_images(self, images):
        ...
        """
        input_h = self.model.input.shape[2]  # Input height of the model
        input_w = self.model.input.shape[1]  # Input width of the model
    ...
    def show_boxes(self, image, boxes, box_classes, box_scores, file_name):
        ...
        Args:
            ...
            boxes (numpy.ndarray): The boundary boxes for the image.
            box_classes (numpy.ndarray): The class indices for each box.
            box_scores (numpy.ndarray): The box scores for each box.
        ...
        if key == ord('s'):
            ...
            save_path = f"detections/{os.path.basename(file_name)}"
