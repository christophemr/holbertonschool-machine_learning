...
class Dataset:
    ...
    def __init__(self, batch_size, max_len):
        ...
        Initializes the train and validation datasets, tokenizers,
        and prepares the datasets for training.
        ...
        self.data_train = self.data_train.filter(self.filter_by_length)
        ...
        self.data_valid = self.data_valid.filter(self.filter_by_length)
    ...
    def filter_by_length(self, pt, en):
        ...
        Args:
            pt (tf.Tensor): Tokenized Portuguese sentence.
            en (tf.Tensor): Tokenized English sentence.

        Returns:
            bool: True if both sentences are within `max_len`, else False.
        """
