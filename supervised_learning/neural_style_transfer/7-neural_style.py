...
class NST:
    ...
    def content_cost(self, content_output):
        ...
        Args:
            content_output (tf.Tensor): A tensor containing the content output
                                        for the generated image.

        Raises:
            TypeError: If content_output is not a tensor with the same shape
        ...
        # Calculate the content cost as the mean squared difference between
        # content_output and self.content_feature
